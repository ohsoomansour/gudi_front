<template>
  <v-container fluid>
    <v-card class="dashboard-card">
      ...
      <v-table class="dashboard-table">
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td @click="openAddModal2">Vue</td>
          </tr>
          <tr>
            <td>2</td>
            <td @click="openAddModal2">Java</td>
          </tr>
        </tbody>
      </v-table>
    </v-card>
    ...
    <div class="button-group">
      <button class="insert-button" @click="openAddModal">시험등록</button>
    </div>
    <v-dialog v-model="addModal" max-width="700px">
      <v-card>
        <v-card-text>
          <ExamManagementModal :action="action" />
        </v-card-text>
      </v-card>
    </v-dialog>
  </v-container>
...
<script>
import ExamManagementModal from "./TTestModal.vue";
export default {
  components: { ExamManagementModal },
  data() {
    return {
      titleText: "시험관리",
      addModal: false,
